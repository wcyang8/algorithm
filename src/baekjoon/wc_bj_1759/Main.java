...
public class Main {
	...
	static boolean condition(int alphabet, int len) {	//password만 체크하려다 alphabet까지 체크.
		int mcnt = 0;									//L -> len으로 바꿔서, password면 len = L, alphabet이면 len = C
		for(int i = 0; i < 26; i++) {
